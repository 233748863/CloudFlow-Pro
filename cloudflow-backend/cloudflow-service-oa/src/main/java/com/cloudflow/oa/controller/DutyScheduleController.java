...
public class DutyScheduleController {
    ...
    /** 分页查询值班排班列表 */
    @GetMapping("/list")
    @SaCheckPermission("oa:duty:list")
    ...
    @SysLog("修改值班排班")
    @PutMapping
    @SaCheckPermission("oa:duty:edit")
    ...
    @SysLog("删除值班排班")
    @DeleteMapping("/{ids}")
    @SaCheckPermission("oa:duty:remove")
    ...
    @SaCheckPermission("oa:duty:checkin")
    ...
    @SaCheckPermission("oa:duty:checkout")
    ...
    @SysLog("换班申请")
    @PutMapping("/swap/{id}")
    @SaCheckPermission("oa:duty:swap")
