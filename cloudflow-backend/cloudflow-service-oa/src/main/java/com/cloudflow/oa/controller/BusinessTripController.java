...
public class BusinessTripController {
    ...
    /** 分页查询出差申请列表 */
    @GetMapping("/list")
    @SaCheckPermission("office:trip:list")
    ...
    @SysLog("新增出差申请")
    @PostMapping
    @SaCheckPermission("office:trip:add")
    ...
    @SysLog("修改出差申请")
    @PutMapping
    @SaCheckPermission("office:trip:edit")
    ...
    @SysLog("删除出差申请")
    @DeleteMapping("/{ids}")
    @SaCheckPermission("office:trip:remove")
    ...
    @SaCheckPermission("office:trip:submit")
    ...
    @SaCheckPermission("office:trip:cancel")
