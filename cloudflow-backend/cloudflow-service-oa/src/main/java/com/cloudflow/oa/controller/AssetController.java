...
public class AssetController {
     ...
     */
    @GetMapping("/list")
    @SaCheckPermission("admin:asset:list")
    public R list(
    ...
    @SysLog("新增资产")
    @PostMapping
    @SaCheckPermission("admin:asset:add")
    ...
    @SysLog("编辑资产")
    @PutMapping
    @SaCheckPermission("admin:asset:edit")
    ...
    @SysLog("删除资产")
    @DeleteMapping("/{id}")
    @SaCheckPermission("admin:asset:remove")
    ...
    @SaCheckPermission("admin:asset:borrow")
    ...
    @SaCheckPermission("admin:asset:return")
    ...
    @SaCheckPermission("admin:asset:repair")
    ...
    @SaCheckPermission("admin:asset:scrap")
