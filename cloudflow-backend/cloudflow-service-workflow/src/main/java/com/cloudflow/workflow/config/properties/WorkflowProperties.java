...
public class WorkflowProperties {
    ...
    public Engine getEngine() {
        engine.setRuntimeSysConfigService(runtimeSysConfigService);
        return engine;
    }
    public void setEngine(Engine engine) { this.engine = engine; }

    public Recall getRecall() {
        recall.setRuntimeSysConfigService(runtimeSysConfigService);
        return recall;
    }
    public void setRecall(Recall recall) { this.recall = recall; }

    public Timer getTimer() {
        timer.setRuntimeSysConfigService(runtimeSysConfigService);
        return timer;
    }
    public void setTimer(Timer timer) { this.timer = timer; }

    public Retry getRetry() {
        retry.setRuntimeSysConfigService(runtimeSysConfigService);
        return retry;
    }
    public void setRetry(Retry retry) { this.retry = retry; }

    public Async getAsync() {
        async.setRuntimeSysConfigService(runtimeSysConfigService);
        return async;
    }
    public void setAsync(Async async) { this.async = async; }

    public Nonce getNonce() {
        nonce.setRuntimeSysConfigService(runtimeSysConfigService);
        return nonce;
    }
    public void setNonce(Nonce nonce) { this.nonce = nonce; }

    public Lock getLock() {
        lock.setRuntimeSysConfigService(runtimeSysConfigService);
        return lock;
    }
    public void setLock(Lock lock) { this.lock = lock; }

    public Script getScript() {
        script.setRuntimeSysConfigService(runtimeSysConfigService);
        return script;
    }
    ...
    public static class Engine {
        ...
        public int getMaxDepth() {
            return intConfig("sys.workflow.maxDepth", maxDepth);
        }
        public void setMaxDepth(int maxDepth) { this.maxDepth = maxDepth; }
        public int getMaxRetryCount() {
            return intConfig("sys.workflow.maxRetryCount", maxRetryCount);
        }
        public void setMaxRetryCount(int maxRetryCount) { this.maxRetryCount = maxRetryCount; }

        void setRuntimeSysConfigService(RuntimeSysConfigService runtimeSysConfigService) {
            this.runtimeSysConfigService = runtimeSysConfigService;
        }

        private int intConfig(String key, int defaultValue) {
            return runtimeSysConfigService == null ? defaultValue : runtimeSysConfigService.getInt(key, defaultValue);
        }
    }
    ...
    public static class Recall {
        ...
        public int getTimeoutHours() {
            return runtimeSysConfigService == null
                    ? timeoutHours
                    : runtimeSysConfigService.getInt("sys.workflow.recallTimeoutHours", timeoutHours);
        }
    ...
    public static class Timer {
        ...
        public int getMaxRetry() {
            return intConfig("sys.workflow.timerMaxRetry", maxRetry);
        }
        public void setMaxRetry(int maxRetry) { this.maxRetry = maxRetry; }
        public int getRetryInterval() {
            return intConfig("sys.workflow.timerRetryInterval", retryInterval);
        }
    ...
    public static class Retry {
        ...
        public int getBaseInterval() {
            return runtimeSysConfigService == null
                    ? baseInterval
                    : runtimeSysConfigService.getInt("sys.workflow.retryBaseInterval", baseInterval);
        }
    ...
    public static class Async {
        ...
        public int getStatusExpireMinutes() {
            return runtimeSysConfigService == null
                    ? statusExpireMinutes
                    : runtimeSysConfigService.getInt("sys.workflow.asyncStatusExpire", statusExpireMinutes);
        }
    ...
    public static class Lock {
        ...
        public int getCountersignWait() {
            return intConfig("sys.workflow.lock.countersignWait", countersignWait);
        }
        public void setCountersignWait(int countersignWait) { this.countersignWait = countersignWait; }
        public int getCountersignLease() {
            return intConfig("sys.workflow.lock.countersignLease", countersignLease);
        }
        public void setCountersignLease(int countersignLease) { this.countersignLease = countersignLease; }
        public int getDeadlockTimeout() {
            return intConfig("sys.workflow.lock.deadlockTimeout", deadlockTimeout);
        }
        public void setDeadlockTimeout(int deadlockTimeout) { this.deadlockTimeout = deadlockTimeout; }
        public int getMaxVictimRecords() {
            return intConfig("sys.workflow.lock.maxVictimRecords", maxVictimRecords);
        }
    ...
    public static class Nonce {
        ...
        public int getExpireMinutes() {
            return runtimeSysConfigService == null
                    ? expireMinutes
                    : runtimeSysConfigService.getInt("sys.workflow.nonceExpireMinutes", expireMinutes);
        }
    ...
    public static class Script {
        ...
        public boolean isEnabled() {
            return runtimeSysConfigService == null
                    ? enabled
                    : runtimeSysConfigService.getBoolean(SysConfigKeys.WORKFLOW_SCRIPT_ENABLED, enabled);
        }
        ...
        public long getTimeoutMs() {
            ...
            return runtimeSysConfigService.getLong(SysConfigKeys.WORKFLOW_SCRIPT_TIMEOUT_MS, timeoutMs);
        }
