 ...
 */
public interface IHrPerformance360Service {
    ...
    List<Hr360EvaluatorRowVO> listEvaluators(Long objectiveId, Long evaluateeId);

    /** 查询某评估人未完成的评估邀请(评估人视角的待办)。 */
    List<Hr360EvaluatorRowVO> listPendingForEvaluator(Long evaluatorId);

    /** 聚合多源得分回填到 hr_performance_result 并返回结果摘要。 */
    Hr360AggregateVO aggregate(Long objectiveId, Long evaluateeId);
}
