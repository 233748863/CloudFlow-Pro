...
export const HrDisputeMediationPage: React.FC = () => (
  <HrSubRecordCrudPage<HrDisputeMediation, HrDisputeMediationPayload>
    ...
    columns={[
      ...
      { header: '结果', render: (r) => <DictLabel dictType="hr_dispute_mediation_result" value={r.result} fallback="-" /> },
    ...
    fields={[
      ...
      { type: 'select', key: 'result', label: '调解结果', dictType: 'hr_dispute_mediation_result' },
