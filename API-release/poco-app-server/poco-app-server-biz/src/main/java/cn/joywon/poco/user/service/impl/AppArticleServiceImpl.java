...
public class AppArticleServiceImpl extends ServiceImpl<AppArticleMapper, AppArticleEntity>
    ...
    @Override
    public AppArticleEntity getArticleByCategoryAndId(Long categoryId, Long id) {
        return baseMapper.selectOne(Wrappers.<AppArticleEntity>lambdaQuery()
                .eq(AppArticleEntity::getId, id)
                .eq(AppArticleEntity::getCid, categoryId));
    }
