 ...
 * @date 2024/10/14
 */
public class PocoDefaultPromptTemplateFactory implements PromptTemplateFactory {

	@Override
	public PocoDefaultPromptTemplateFactory.DefaultTemplate create(PromptTemplateFactory.Input input) {
		return new PocoDefaultPromptTemplateFactory.DefaultTemplate(input.getTemplate());
	}
