package cn.joywon.poco.mp.handler;

import cn.hutool.json.JSONArray;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.baomidou.mybatisplus.core.toolkit.Wrappers;
import cn.joywon.poco.mp.config.WxMpContextHolder;
import cn.joywon.poco.mp.constant.MsgTypeEnum;
import cn.joywon.poco.mp.constant.ReplyMateEnum;
import cn.joywon.poco.mp.constant.ReplyTypeEnum;
import cn.joywon.poco.mp.entity.WxAccount;
import cn.joywon.poco.mp.entity.WxAccountFans;
import cn.joywon.poco.mp.entity.WxAutoReply;
import cn.joywon.poco.mp.entity.WxMsg;
import cn.joywon.poco.mp.mapper.WxAccountMapper;
import cn.joywon.poco.mp.mapper.WxMsgMapper;
import cn.joywon.poco.mp.service.WxAccountFansService;
import cn.joywon.poco.mp.service.WxAutoReplyService;
        ...
        if (!wxMessage.getMsgType().equals(XmlMsgType.EVENT)) {
            ...
            if (Objects.isNull(fans)) {
                ...
                try {
                    ...
                    return new cn.joywon.poco.mp.builder.TextBuilder().build("感谢使用", wxMessage, wxMpService);
                }
