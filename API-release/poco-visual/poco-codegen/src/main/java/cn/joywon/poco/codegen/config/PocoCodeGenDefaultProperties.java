package cn.joywon.poco.codegen.config;
...
@ConfigurationProperties(prefix = PocoCodeGenDefaultProperties.PREFIX)
public class PocoCodeGenDefaultProperties implements InitializingBean {
	 ...
	 * 生成代码的包名
	 */
	private String packageName = "cn.joywon.poco";
	 ...
	 * 生成代码的后端路径
	 */
	private String backendPath = "poco";

	/**
	 * 生成代码的前端路径
	 */
	private String frontendPath = "poco-ui";

	/**
	 * 生成代码的作者
	 */
	private String author = "poco";

	/**
	 * 生成代码的邮箱
	 */
	private String email = "sw@poco.vip";
