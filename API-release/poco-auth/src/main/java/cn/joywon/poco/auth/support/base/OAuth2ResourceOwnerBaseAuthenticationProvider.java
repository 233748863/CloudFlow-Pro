package cn.joywon.poco.auth.support.base;

import cn.hutool.core.util.BooleanUtil;
import cn.hutool.extra.spring.SpringUtil;
import cn.joywon.poco.common.core.constant.CommonConstants;
import cn.joywon.poco.common.security.service.PocoRedisOAuth2AuthorizationService;
import cn.joywon.poco.common.security.util.OAuth2ErrorCodesExpand;
import cn.joywon.poco.common.security.util.ScopeException;
...
public abstract class OAuth2ResourceOwnerBaseAuthenticationProvider<T extends OAuth2ResourceOwnerBaseAuthenticationToken>
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        try {
            ...
            PocoRedisOAuth2AuthorizationService redisOAuth2AuthorizationService = (PocoRedisOAuth2AuthorizationService) this.authorizationService;
