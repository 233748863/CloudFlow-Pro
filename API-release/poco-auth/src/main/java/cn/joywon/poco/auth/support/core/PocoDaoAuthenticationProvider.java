package cn.joywon.poco.auth.support.core;
 ...
 * @date 2022-06-04
 */
public class PocoDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	public PocoDaoAuthenticationProvider() {
	...
	protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
		...
		Map<String, PocoUserDetailsService> userDetailsServiceMap = SpringUtil
