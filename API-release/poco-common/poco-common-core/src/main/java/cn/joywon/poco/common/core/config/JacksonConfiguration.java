 ...
 * {@link cn.joywon.poco.common.core.jackson.PocoJavaTimeModule}、默认时区等
 *
 * @author L.cm
 * @author poco
 * @author lishangbu
...
public class JacksonConfiguration implements WebMvcConfigurer {
	...
	public Jackson2ObjectMapperBuilderCustomizer customizer() {
		return builder -> {
			...
			builder.modules(new PocoJavaTimeModule());
		};
	}

	/**
	 * 增加GET请求参数中时间类型转换 {@link cn.joywon.poco.common.core.jackson.PocoJavaTimeModule}
	 * <ul>
