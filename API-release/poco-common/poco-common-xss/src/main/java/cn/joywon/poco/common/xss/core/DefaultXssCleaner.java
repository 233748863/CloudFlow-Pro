...
package cn.joywon.poco.common.xss.core;

import cn.hutool.core.util.CharsetUtil;
import cn.joywon.poco.common.xss.config.PocoXssProperties;
import cn.joywon.poco.common.xss.utils.XssUtil;
...
public class DefaultXssCleaner implements XssCleaner {
	...
	private final PocoXssProperties properties;
	...
	public String clean(String bodyHtml) {
		...
		PocoXssProperties.Mode mode = properties.getMode();
		if (PocoXssProperties.Mode.escape == mode) {
			// html 转义
