package cn.joywon.poco.common.sensitive;

import cn.joywon.poco.common.core.constant.CacheConstants;
import cn.joywon.poco.common.core.util.SpringContextHolder;
import cn.joywon.poco.common.sensitive.core.SensitiveService;
import cn.joywon.poco.common.sensitive.util.RemoteSensitiveService;
import cn.joywon.poco.common.sensitive.util.SensitiveWordsProperties;
import cn.joywon.poco.common.sensitive.word.SensitiveWordCustomizer;
...
public class SensitiveAutoConfiguration implements InitializingBean {
    ...
    @Qualifier("redisMessageListenerContainerOptional")
