package cn.joywon.poco.common.sequence.builder;

import cn.joywon.poco.common.core.util.SpringContextHolder;
import cn.joywon.poco.common.sequence.range.BizName;
import cn.joywon.poco.common.sequence.range.impl.redis.RedisSeqRangeMgr;
import cn.joywon.poco.common.sequence.sequence.Sequence;
import cn.joywon.poco.common.sequence.sequence.impl.DefaultRangeSequence;
