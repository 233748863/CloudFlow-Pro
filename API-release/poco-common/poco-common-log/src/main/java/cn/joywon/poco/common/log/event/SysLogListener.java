...
public class SysLogListener implements InitializingBean {
	...
	private final PocoLogProperties logProperties;
	...
	public void afterPropertiesSet() {
		...
		JacksonSensitiveFieldUtil.registerCustomModule(new PocoJavaTimeModule());
	}
}
