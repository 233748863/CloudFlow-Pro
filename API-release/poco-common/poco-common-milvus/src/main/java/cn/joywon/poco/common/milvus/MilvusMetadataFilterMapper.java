...
class MilvusMetadataFilterMapper {
	...
	private static String mapEqual(IsEqualTo isEqualTo, String metadataFieldName) {
		return format("%s == %s", formatKey(isEqualTo.key(), metadataFieldName),
	...
	private static String mapNotEqual(IsNotEqualTo isNotEqualTo, String metadataFieldName) {
		return format("%s != %s", formatKey(isNotEqualTo.key(), metadataFieldName),
	...
	private static String mapGreaterThan(IsGreaterThan isGreaterThan, String metadataFieldName) {
		return format("%s > %s", formatKey(isGreaterThan.key(), metadataFieldName),
	...
	private static String mapGreaterThanOrEqual(IsGreaterThanOrEqualTo isGreaterThanOrEqualTo,
		...
		return format("%s >= %s", formatKey(isGreaterThanOrEqualTo.key(), metadataFieldName),
	...
	private static String mapLessThan(IsLessThan isLessThan, String metadataFieldName) {
		return format("%s < %s", formatKey(isLessThan.key(), metadataFieldName),
	...
	private static String mapLessThanOrEqual(IsLessThanOrEqualTo isLessThanOrEqualTo, String metadataFieldName) {
		return format("%s <= %s", formatKey(isLessThanOrEqualTo.key(), metadataFieldName),
	...
	private static String mapNotIn(IsNotIn isNotIn, String metadataFieldName) {
		return format("%s not in %s", formatKey(isNotIn.key(), metadataFieldName),
				formatValues(isNotIn.comparisonValues()));
	}
