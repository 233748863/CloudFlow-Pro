package cn.joywon.poco.common.sentinel.feign;
 ...
 * @date 2020/6/9
 */
public final class PocoSentinelFeign {

	private PocoSentinelFeign() {

	}

	public static PocoSentinelFeign.Builder builder() {
		return new PocoSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public PocoSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new PocoSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new PocoSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new PocoSentinelInvocationHandler(target, dispatch);
				}
