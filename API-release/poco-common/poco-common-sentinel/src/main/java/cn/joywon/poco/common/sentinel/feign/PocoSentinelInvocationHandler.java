 ...
 */
@Slf4j
public class PocoSentinelInvocationHandler implements InvocationHandler {
	...
	PocoSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			PocoSentinelInvocationHandler other = (PocoSentinelInvocationHandler) obj;
