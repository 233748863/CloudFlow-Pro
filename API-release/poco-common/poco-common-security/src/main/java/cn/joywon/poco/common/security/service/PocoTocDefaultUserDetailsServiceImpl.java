...
import cn.joywon.poco.user.api.feign.RemoteAppUserService;
...
public class PocoTocDefaultUserDetailsServiceImpl implements PocoUserDetailsService {
    ...
    UserDetails convertUserDetailsAppUser(AppUserInfo info) {
        ...
        return new PocoUser(user.getUserId(), user.getUsername(), null, user.getPhone(), user.getAvatar(),
