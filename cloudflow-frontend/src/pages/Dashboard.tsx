              ...
              {la ? <Skeleton /> : recentApps.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-12 text-slate-400">
                  ...
                  <Button
                    ...
                    className="mt-3 text-sm font-semibold text-pink-500 hover:text-pink-600 flex items-center gap-1.5 transition-colors px-4 py-2 rounded-xl hover:bg-pink-50 active:scale-95 h-auto"
                  >
              ...
              {ls ? <Skeleton /> : schedules.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-10 text-slate-400">
                  ...
                  <Button
                    variant="ghost"
                    onClick={() => navigate('/schedule')}
                    className="mt-3 text-sm font-semibold text-blue-500 hover:text-blue-600 flex items-center gap-1.5 px-4 py-2 rounded-xl hover:bg-blue-50 active:scale-95 transition-colors h-auto"
                  >
