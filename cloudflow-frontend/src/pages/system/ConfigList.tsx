          ...
          <table className="w-full">
            <TableHeader>
              <tr>
                ...
                <TableHead className="px-6 py-3 text-left">参数名称</TableHead>
                <TableHead className="px-6 py-3 text-left">参数键名</TableHead>
                <TableHead className="px-6 py-3 text-left">参数键值</TableHead>
                <TableHead className="px-6 py-3 text-left">类型</TableHead>
                <TableHead className="px-6 py-3 text-left">作用域</TableHead>
