              ...
              filterBar={(
                <div className="grid grid-cols-1 gap-2.5 xl:grid-cols-[minmax(0,1fr)_auto_auto]">
                  <Select value={categoryInput} onValueChange={setCategoryInput}>
                    <SelectTrigger className="h-10 rounded-[18px] border-white/85 bg-white/78 px-4 shadow-[0_10px_22px_rgba(15,23,42,0.04)] backdrop-blur-md"><SelectValue placeholder="按报销类别筛选" /></SelectTrigger>
