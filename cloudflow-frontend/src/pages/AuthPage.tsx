...
const TenantSelect: React.FC<TenantSelectProps> = ({
  ...
  <div className="cf-auth-input-wrap">
    <Select value={value} onValueChange={onChange} disabled={disabled}>
      ...
      <SelectTrigger
        id={id}
        className="h-[2.875rem] rounded-[0.9rem] pl-11 pr-3 text-[0.95rem]"
      >
            ...
            <div className="cf-auth-card__section">
              ...
              {isLogin ? (
                <form onSubmit={handleLoginSubmit} className="cf-auth-form">
                  <div>
                    <label htmlFor="auth-login-tenant" className="cf-auth-label">
                      租户
                    </label>
                    <TenantSelect
                ...
                <form onSubmit={handleRegisterSubmit} className="cf-auth-form">
                  <div>
                    <label htmlFor="auth-register-tenant" className="cf-auth-label">
                      租户
                    </label>
                    <TenantSelect
