...
export const AnnouncementPopup: React.FC = () => {
  ...
  return createPortal(
    <div className="cf-announcement-popup-overlay fixed inset-0 z-[120] flex items-start justify-center overflow-y-auto bg-slate-950/40 p-4 pt-[8vh] backdrop-blur-[2px]">
      <div className="cf-announcement-popup-panel w-full max-w-[680px] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_22px_44px_rgba(15,23,42,0.14)] ring-1 ring-slate-200/80">
        <div className="border-b border-slate-100 bg-white px-5 py-4">
          ...
          <div className="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-slate-50/80 px-3 py-1 text-sm text-slate-500">
            <Clock3 size={16} />
            <time>{formatAnnouncementRelativeWithDateTime(currentPopup.publishTime || currentPopup.createTime)}</time>
          </div>
        </div>

        <div className="cf-announcement-scroll max-h-[50vh] overflow-y-auto bg-white px-5 py-5">
