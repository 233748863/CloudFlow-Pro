...
export const WorkflowCatalogGrid: React.FC<WorkflowCatalogGridProps> = ({
  ...
  <div className="card">
    <div className="flex items-center justify-between border-b border-slate-100 px-6 py-4">
      <div>
        <h2 className="text-lg font-semibold text-slate-900">可发起流程</h2>
        <p className="mt-1 text-sm text-slate-500">统一展示分类、标签和入口动作。</p>
      </div>
            ...
            return (
              ...
              >
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span
                    className={`badge ${
                      workflow.formId ? 'badge-success' : 'badge-warning'
                    }`}
                  >
