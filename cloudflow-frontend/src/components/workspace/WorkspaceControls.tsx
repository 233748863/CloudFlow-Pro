...
export const WorkspaceControlGroup: React.FC<WorkspaceControlGroupProps> = ({
  ...
  <div
    className={cn(
      'inline-flex h-10 items-center overflow-hidden rounded-md border border-slate-200 bg-[var(--cf-surface-strong)] shadow-none dark:border-slate-800 dark:bg-slate-950',
      className,
    )}
  >
    {children}
