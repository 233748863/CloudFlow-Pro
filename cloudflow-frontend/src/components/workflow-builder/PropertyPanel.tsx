...
export const PropertyPanel = ({
 ...
 <div className="admin-dialog-field border-t border-slate-200 pt-3 dark:border-slate-700">
 ...
 <span className="text-xs font-medium text-cf-body">
 允许编辑表单
 </span>
 <input
 type="checkbox"
 className="h-4 w-4 cursor-pointer rounded border-slate-300 text-cf-body focus:ring-slate-400 dark:border-slate-700 dark:focus:ring-slate-600"
 ...
 className={`font-mono text-[11px]${!conditionValidation.valid ? "border-rose-400 focus:border-rose-500 focus:ring-rose-200" : ""}`}
          ...
          {[
            ...
            <div className="admin-dialog-field border-t border-slate-200 pt-3 pb-3 dark:border-slate-700">
              <div className={studioSectionTitleClassName}>高级设置</div>

              <div className={studioSubtleBlockClassName}>
                <span className="text-xs text-cf-muted font-medium">
                  节点重试策略
                </span>
                <div className="grid grid-cols-2 gap-3 mt-2">
                  <div>
                    <span className="text-[10px] text-cf-faint mb-1 block">
                      最大重试次数
                    </span>
                    <LazyInput
                      type="number"
              ...
              <div className={studioSubtleBlockClassName}>
                <span className="text-xs text-cf-muted font-medium mb-1 block">
                  输入映射 (Inputs JSON)
                </span>
                <LazyTextarea
