          ...
          <>
            {isModalOpen ? (
              ...
              >
                ...
                >
                  <div className="relative overflow-hidden border-b border-gray-100/90 bg-gradient-to-br from-blue-50/80 to-indigo-50/30 px-6 py-5">
                    <div className="relative z-10 flex items-start justify-between gap-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          type="button"
                          onClick={() => setIsModalOpen(false)}
                          className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/70 text-gray-500 transition-all hover:bg-white hover:text-gray-700"
                          aria-label="关闭公告弹层"
                        >
                          <X size={16} />
                        </button>
                  ...
                  <div className="max-h-[65vh] overflow-y-auto">
                    {loading ? (
                      ...
                      <div>
                        {announcements.map((item) => (
                          <button
                            ...
                            type="button"
                            className={`group relative flex w-full items-center gap-4 border-b border-gray-100 px-6 py-4 text-left transition-all hover:bg-gray-50 ${
                      ...
                      <div className="flex flex-col items-center justify-center py-16">
                        <div className="mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-gray-100 to-gray-200 text-gray-400">
                          <Bell size={28} />
                        </div>
                  ...
                  <div className="border-t border-gray-100 bg-gray-50/60 px-6 py-4">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <button
                        ...
                        className="rounded-xl border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm transition-all hover:bg-gray-50"
                      >
                        进入公告中心
                      </button>
                    </div>
            ...
            {detailOpen && selectedAnnouncement ? (
              ...
              >
                <div
                  ...
                  onClick={(event) => event.stopPropagation()}
                >
                  <div className="relative overflow-hidden border-b border-gray-100 bg-gradient-to-br from-blue-50/80 via-indigo-50/50 to-purple-50/20 px-8 py-6">
                    ...
                    <div className="relative z-10 flex items-start justify-between gap-4">
                      ...
                      <button
                        ...
                        className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-white/60 text-gray-500 transition-all hover:bg-white hover:text-gray-700 hover:shadow-lg"
                        aria-label="关闭公告详情"
                      >
                        <X size={18} />
                      </button>
                  ...
                  <div className="border-t border-gray-100 bg-gray-50/60 px-8 py-5">
                    <div className="flex items-center justify-between gap-3">
                      <div className="text-xs text-gray-500">
                      ...
                      <div className="flex items-center gap-3">
                        <button
                          ...
                          className="rounded-xl border border-gray-300 bg-white px-5 py-2.5 text-sm font-medium text-gray-700 shadow-sm transition-all hover:bg-gray-50"
                        >
                          关闭
                        </button>
                        <button
  ...
  return (
    <>
      <button
        ...
        className={`relative flex h-9 w-9 items-center justify-center rounded-lg text-gray-600 transition-all hover:scale-[1.03] hover:bg-gray-100 ${
