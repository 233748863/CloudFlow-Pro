<template>
	<div class="flex justify-center items-center px-5 py-5 min-h-screen bg-gray-100 dark:bg-slate-900 min-w-screen">
		<!-- 右上角控制组件 -->
		<Control />

		<div
			class="overflow-hidden w-full bg-white rounded-3xl border border-gray-200 shadow-lg dark:bg-slate-800 dark:border-slate-700"
