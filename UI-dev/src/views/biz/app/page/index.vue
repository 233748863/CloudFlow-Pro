<template>
	<div class="layout-padding decoration-pages min-w-[1100px]">
		<el-card :body-style="{ flex: 1 }" class="!border-none flex-1 flex" shadow="never">
			<div class="flex items-start h-full">
				<Menu v-model="activeMenu" :menus="menus" />
				<preview v-model="selectWidgetIndex" :page-data="getPageData">
					<template #footer>
				...
				<attr-setting :widget="getSelectWidget" class="flex-1" />
			</div>
		</el-card>
	</div>
</template>
